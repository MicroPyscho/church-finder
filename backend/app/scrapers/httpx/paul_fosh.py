"""
Paul Fosh Auctions — leading Wales auction house.
Frequently lists chapels and former churches in Wales.
"""
import asyncio
...
class PaulFoshScraper(BaseScraper):
    ...
    source_type = "httpx"
    SEARCHES = [
        "https://www.paulfosh.co.uk/auctions/properties/?q=church",
        "https://www.paulfosh.co.uk/auctions/properties/?q=chapel",
        "https://www.paulfosh.co.uk/auctions/properties/?q=place+of+worship",
    ]
            ...
            try:
                ...
                for card in soup.select("div[class*=property], article, li[class*=lot]"):
                    ...
                    if not href.startswith("http"):
                        href = "https://www.paulfosh.co.uk" + href
                    if href in seen:
                        continue
                ...
                self.logger.warning("PaulFosh %s: %s", url, e)
